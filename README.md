...
<!-- OPENSYNC_START -->
**[prompt-injection-ctf](https://github.com/ppradyoth/prompt-injection-ctf)** (⭐ 3) — Interactive AI Security Playground — Prompt Injection CTF. Craft attack prompts to break constrained AI systems. Learn prompt injection, jailbreaking, intent drift & token smuggling. Built to teach adversarial thinking hands-on.
